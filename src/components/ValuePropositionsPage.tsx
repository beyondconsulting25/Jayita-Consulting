...
interface ValuePropositionsPageProps {
  onBackToHome: () => void;
}

export default function ValuePropositionsPage({ onBackToHome }: ValuePropositionsPageProps) {
  useEffect(() => {
  ...
  return (
    <div className="bg-background min-h-screen text-text-main font-sans pb-20 transition-colors duration-200">
      ...
      <ValueAndExposure initialTab="propositions" />
    </div>
  );
}
